...
import { ArrowLeft, Calculator, Utensils, Clock, ChefHat } from 'lucide-react';
...
export default function DietRecommendation() {
  ...
  const dietMutation = useMutation({
    mutationFn: async (userProfile: UserProfile) => {
      const response = await apiRequest('POST', '/api/diet/recommend', userProfile);
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select value={profile.weight_goal} onValueChange={(value) => handleInputChange('weight_goal', value)}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
              ...
              >
                ...
                {dietMutation.isPending ? 'Generating...' : 'Generate Diet Plan'}
              </Button>
            </CardContent>
          </Card>
