...
function App() {
  ...
  const modernNavbarPages = ['/', '/about', '/contact', '/food-database', '/health-insights', '/generic', '/customized', '/ai-meal-budget-planner', '/healing-recipes', '/ai-health-forecast', '/consumer-rights'];
